          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Complete a 2-minute quiz about your body, goals, and lifestyle.
                This is the key to your unique plan.
              </p>
            </div>
            <div className="p-6">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-500 mx-auto mb-4">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Our algorithm instantly calculates your ideal calories & macros
                and generates a starting workout plan.
              </p>
            </div>
            <div className="p-6">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-500 mx-auto mb-4">
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-4 max-w-xl mx-auto text-lg text-blue-100">
            Your future self will thank you. The plan is free. The only thing it
            costs is an excuse.
          </p>
          <div className="mt-8">
            <Button
